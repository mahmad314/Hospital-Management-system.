...
using namespace std;
    ...
    {
        fstream file("./data/doctor.txt", ios::app);
        fstream dc("./data/counter.txt", ios::out);
        dc<<Doctor::count;
...
void Doctor :: getdata()
{
    ...
    fstream fil("./data/doctor.txt", ios::in);
    fstream dc("./data/counter.txt", ios::in);
    //
    agee = new int[tem];
    i_d = new int[tem];
    name = new string[tem];
...
{
    string t;
    fstream fil("./data/counter.txt", ios::in);
    getline(fil, t);
    t=removeSpaces(t);
