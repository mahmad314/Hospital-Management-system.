...
{
    fstream file("./data/Patient.txt", ios::app);
    fstream dc("./data/pcounter.txt", ios::out);
    dc << Patient::count;
...
void Patient ::getpdata()
{
    ...
    fstream fil("./data/Patient.txt", ios::in);
    fstream dc("./data/pcounter.txt", ios::in);
    //
    agee = new int[ptem];
    i_d = new int[ptem];
...
{
    string t;
    fstream fil("./data/pcounter.txt", ios::in);
    getline(fil, t);
    t = removeSpaces(t);
