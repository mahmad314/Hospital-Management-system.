...
void Nurse ::savedata()
{
    fstream file("nurse.txt", ios::app);
    fstream dc("N_counter.txt", ios::out);
    dc << Nurse::count;
...
void Nurse ::getNdata()
{
    ...
    fstream fil("nurse.txt", ios::in);
    fstream dc("N_counter.txt", ios::in);
    //
    agee = new int[ntem];
    i_d = new int[ntem];
...
{
    string t;
    fstream fil("N_counter.txt", ios::in);
    getline(fil, t);
    t = removeSpaces(t);
